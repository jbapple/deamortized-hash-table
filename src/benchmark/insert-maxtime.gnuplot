...
#set logscale x 10
plot \
"insert-maxtime-REPLACE1.dat" using 1:2 with lines lc rgb "red" lw 1 title "REPLACE2", \
"insert-maxtime-REPLACE1.dat" using 1:3 with lines lc rgb "blue" lw 1 title "REPLACE3"
