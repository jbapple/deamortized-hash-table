...
set logscale x
plot \
     "./insert-maxtime-6.dat" using 4:3:(log((($3 * 3)>1)?($3 * 3):1)) pt 7 ps variable lc rgb "#00cc00" title "mmap/tiered hash", \
     "./insert-maxtime-0.dat" using 4:3:(log((($3 * 3)>1)?($3 * 3):1)) pt 7 ps variable lc rgb "#cc0000" title "hash table", \
     "./insert-maxtime-1.dat" using 4:3:(log((($3 * 3)>1)?($3 * 3):1)) pt 7 ps variable lc rgb "#0000cc" title "tree"
